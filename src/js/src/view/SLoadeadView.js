...
(function ($, _, Backbone, umobile, config) {
	...
	@constructor
	**/
	umobile.view.SLoadedView = umobile.view.SBase.extend({
		/**
		...
		**/
		...
		@param {Object} collection Reference to NotificationCollection.
		**/
		...
		**/
		render: function () {
			...
			// Define & Initialize.
			var collection = umobile.app.notificationCollection.toJSON();
			var	viewManager = umobile.app.viewManager;
			var	currentView = viewManager.currentView.getViewName();
